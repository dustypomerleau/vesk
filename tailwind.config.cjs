...
const config = {
    ...
    theme: {
        colors: {
            ...
            logoSky: "#1785be",
            orange: {
                a: "#ffdfc6", // not p3, closest to oklch(92.45% 0.789007315343796 61.340375131646900)
                b: "#ffc9a0", // not p3, closest to oklch(87.45% 0.639007315343796 58.740375131646900)
                c: "#ffb27a", // not p3, closest to oklch(82.45% 0.489007315343796 56.140375131646900)
                d: "#ff984f", // not p3, closest to oklch(77.45% 0.339007315343796 53.540375131646900)
                e: "#ff7b00", // closest to oklch(72.45% 0.189007315343796 50.9403751316469)
                f: "#e76904", // oklch(66.45% 0.179007315343796 48.3403751316469)
                g: "#cf5805", // oklch(60.45% 0.169007315343796 45.7403751316469)
                h: "#b84804", // oklch(54.45% 0.159007315343796 43.1403751316469)
                i: "#a03702", // oklch(48.45% 0.149007315343796 40.5403751316469)
                j: "#892800", // oklch(42.45% 0.139007315343796 37.9403751316469)
                k: "#721900", // closest to oklch(36.45% 0.129007315343796 35.3403751316469)
                l: "#5b0c00", // closest to oklch(30.45% 0.119007315343796 32.7403751316469)
                m: "#440200", // closest to oklch(24.45% 0.109007315343796 30.1403751316469)
                50: "#fcf5ee",
                100: "#fcd9b9",
                200: "#fdba80",
                300: "#ff9843",
